...
@dataclass
class NormComputeModelArguments:
    model_path: str = None
...
@dataclass
class Arguments:
    model: "NormComputeModelArguments" = field(default_factory=NormComputeModelArguments)
...
if __name__ == "__main__":
    ...
    if args.data.norm_path is None:
        args.data.norm_path = args.data.norm_stats_file
